...
function checkAnswers() {
    submissionTimes++;
    if (index1 == 1 && index2 == 2 && index3 == 3 && index4 == 4) {
    ...
    if (index1 != 1) document.querySelector('.firstContent').classList.add('wrong');
    else document.querySelector('.firstContent').classList.add('correct');
    if (index2 != 2) document.querySelector('.secondContent').classList.add('wrong');
    else document.querySelector('.secondContent').classList.add('correct');
    if (index3 != 3) document.querySelector('.thirdContent').classList.add('wrong');
    else document.querySelector('.thirdContent').classList.add('correct');
    if (index4 != 4) document.querySelector('.fourthContent').classList.add('wrong');
...
function showSolution() {
    ...
    document.querySelector('.firstContent').children[1].classList.add('show');
    document.querySelector('.secondContent').children[2].classList.add('show');
    document.querySelector('.thirdContent').children[3].classList.add('show');
